...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ...
    data-slot="card"
    className={cn(
      "rounded-[2rem] border border-[rgba(255,255,255,0.78)] bg-[linear-gradient(180deg,rgba(248,247,244,0.96),rgba(255,255,255,0.82))] text-card-foreground shadow-[0_28px_72px_-40px_rgba(16,42,67,0.24)] backdrop-blur-md",
      className,
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-xl font-semibold leading-tight tracking-tight md:text-2xl", className)} {...props} />
  ),
);
