                            ...
                            {formData.property_type === 'Apartment' && (
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-[#0e2e50]/50" size={16} />
                                            <Input
                                                name="stories"
                                                type="number"
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border border-border max-w-5xl mx-auto overflow-hidden">
            ...
            <div className="min-h-[500px]">
                <AnimatePresence mode="wait">
                    ...
                    {currentStep === 'details' && (
                        <motion.div key="details" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-10">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                {[
                                    { label: 'Bedrooms', name: 'bedrooms', icon: Home },
                                    { label: 'Bathrooms', name: 'bathrooms', icon: Waves },
